<script>
  ...
  <footer class="bg-black text-white pt-10 md:pt-24 lg:pt-32 pb-8 lg:pb-10">
	<div class="w-[95%] md:w-[90%] mx-auto px-2 md:px-4">
	  ...
	  <div class="flex flex-col lg:flex-row justify-between items-center gap-8 pt-8 lg:pt-10">
		...
		<!-- QR Code -->
		<div class="flex items-center bg-white p-3 md:p-4 rounded-lg order-first lg:order-last">
		  <img src='/qr.png' alt="QR Code" class="w-16 h-16 md:w-20 md:h-20">
		</div>
	  </div>
	</div>
  </footer>
